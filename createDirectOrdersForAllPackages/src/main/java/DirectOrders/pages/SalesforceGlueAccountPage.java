...
/***********************************************************************WEB ELEMENTS************************************************************************************/
    ...
    private WebElementFacade nextMonthMP_DMI()   { return element(By.xpath("//thead/tr[1]/th/span[5]/span[3]/i"));									}
...
//									 title().selectByVisibleText(record.get("title"));
								 ...
								 element.findElement(By.xpath("//tbody/tr[6]/td[7]")).click(); /**************** Date Field*****************/
						    	 waitFor(5).seconds(); 
